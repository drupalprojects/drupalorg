...
$handler->display->display_options['title'] = 'Security public service announcements';
...
$handler->display->display_options['header']['text']['content'] = 'Security-related announcements, such as information on best practices. These posts by the Drupal security team are also sent to the security announcements e-mail list.';
...
$handler->display->display_options['path'] = 'security/psa';
...
/* Display: Block */
$handler = $view->new_display('block', 'Block', 'security_psa');
...
$handler->display->display_options['use_more_text'] = 'More Security PSAs';
