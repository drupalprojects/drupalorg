...
<div id="header-feature">
  ...
  <div class="examples">
    ...
    <div class="slideshow">
      <?php print theme('image', array('path' => drupal_get_path('module', 'drupalorg') .'/images/d7-sites/examiner.png', 'Examiner.com')); ?>
      <?php print theme('image', array('path' => drupal_get_path('module', 'drupalorg') .'/images/d7-sites/chicago-public-media.png', 'Chicago Public Media')); ?>
      <?php print theme('image', array('path' => drupal_get_path('module', 'drupalorg') .'/images/d7-sites/drupal-gardens.png', 'Drupal Gardens')); ?>
      <?php print theme('image', array('path' => drupal_get_path('module', 'drupalorg') .'/images/d7-sites/subhublite.png', 'SubHubLite')); ?>
      <?php print theme('image', array('path' => drupal_get_path('module', 'drupalorg') .'/images/d7-sites/iqmetrix.png', 'iQmetrix')); ?>
      <?php print theme('image', array('path' => drupal_get_path('module', 'drupalorg') .'/images/d7-sites/sagmeister.png', 'Stefan Sagmeister')); ?>
      <?php print theme('image', array('path' => drupal_get_path('module', 'drupalorg') .'/images/d7-sites/voxel.png', 'Voxel')); ?>
      <?php print theme('image', array('path' => drupal_get_path('module', 'drupalorg') .'/images/d7-sites/ipswich-brewery.png', 'Ipswich Brewery')); ?>
      <?php print theme('image', array('path' => drupal_get_path('module', 'drupalorg') .'/images/d7-sites/left-click.png', 'Left-click')); ?>
    </div>
  </div>
...
<div id="features">
  ...
  <div class="distribution-support">
