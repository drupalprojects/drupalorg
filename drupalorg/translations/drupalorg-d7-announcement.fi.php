...
$strings = array(
  ...
  '<a href="@install-url">Drupal 7:n asentaminen</a>',
  '<a href="@upgrade-url">Upgrading from version 6</a>' =>
  '<a href="@upgrade-url">Päivittäminen versiosta 6</a>',
  '<a href="@api-url">API Documentation</a>' =>
  '<a href="@api-url">API-dokumentaatio</a>',
  'More topics in the <a href="@documentation-url">online documentation</a>.' =>
  'Lisää aiheita <a href="@documentation-url">online-dokumentaatiossa</a>.',
  'Features' =>
  'Ominaisuudet',
  'Flexible content' =>
  'Joustavat sisällöt',
  ...
  'Määrittele itse tietokenttiä, joita voidaan käyttää eri sivutyypeissä, käyttäjätiedoissa, luokitteluissa ja muissa sisällöissä. Tietojen tallennuksessa voi olla käytössä SQL, <a href="@nosql-url">NoSQL</a> tai etäpalvelin.',
  'Better theming' =>
  ...
  'Automatisoitu testausjärjestelmä, jossa on yli 30000 sisäänrakennettua testiä suorittamaan <a href="@qa-url">jatkuvaa integraatiotestausta</a> muutoksille Drupalin koodissa ja laajennusmoduuleissa.',
  'Improved database support' =>
  'Parannettu tietokantatuki',
  ...
  'Uuden tietokantakerroksen myötä valmis tuki SQLite-, MySQL-/MariaDB- ja PostgreSQL-tietokannoille. <a href="@sqlsrv-url">MS SQL Server</a> ja <a href="@oracle-url">Oracle</a> ovat käytettävissä laajennusmoduuliensa avulla.',
  'Better distribution support' =>
  'Parannettu tuki jakamiseen',
  ...
  'Asennusprofiileita käyttäen voit jakaa räätälöimäsi Drupal-tuotteen. Myös uusi rajapinta ja koodin kautta vietävissä olevat konfiguraatiot tehostavat jakamista.',
  'Extend' =>
  ...
  'Drupal 7 on jo käytössä sadoilla sivustoilla. Tässä muutama esimerkki:',
  ...
  'Asennusta varten Drupal 7 tarvitsee seuraavat valmiudet:',
  '<strong>Web Server</strong>: Apache (recommended), Nginx, Lighttpd, or Microsoft IIS' =>
  '<strong>WWW-palvelin</strong>: Apache (suositeltu), Nginx, Lighttpd tai Microsoft IIS',
  '<strong>Database</strong>: MySQL 5.0.15 and higher, PostgreSQL 8.3 and higher, or SQLite 3.x' =>
  '<strong>Tietokanta</strong>: MySQL 5.0.15 tai uudempi, PostgreSQL 8.3 tai uudempi, SQLite 3.x',
  '<strong>PHP</strong>: 5.2.4 and higher' =>
  '<strong>PHP</strong>: 5.2.4 tai uudempi',
