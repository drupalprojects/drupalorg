...
$strings = array(
  ...
  'Vi er stolte av å presentere deg vårt beste arbeid hittil &ndash; Drupal 7, den vennlige og kraftfulle publiseringsplattform som kan brukes til å bygge nesten alle slags nettsteder: fra blogger og mikronettsteder for sosiale fellesskap.',
  ...
  'Et helt nytt administrativt grensesnitt gjør det enklere å løse dine daglige oppgaver. Det ble lagt inn mange forbedringer spesielt for nettstedsadministratorer og redaktører.',
  'More flexible' =>
  'Mer fleksibel',
  ...
  'Bestem din egen innholdsstruktur og legge til egendefinerte felt for innhold, brukere, kommentarer m.m. Utvid ditt nettsted med en av over 800 moduler som allerede er tilgjengelige for Drupal 7.',
  'More scalable' =>
  'Mer skalérbar',
  ...
  'Ditt Drupal 7-nettsted vil være rask og i stand til å håndtere store volumer av trafikk takket være bedre JavaScript- og CSS-optimalisering, bedre caching, m.m.',
  'Open source' =>
  'Åpen kilde',
  ...
  'Come for the software, stay for the community. Tusenvis av intelligente og produktive mennesker arbeider sammen for å kontinuerlig forbedre Drupal, moduler, utseendemaler og distribusjoner.',
  'Take a tour' =>
  'Ta en tur',
  'Learn more' =>
  'Lær mer',
  'Get started with updated documentation for Drupal 7:' =>
  'Kom i gang med oppdatert dokumentasjon for Drupal 7:',
  ...
  'Opprett egendefinerte felt som kan brukes på tvers av innholdstyper, brukere, kommentarer, termer og andre entititer. Lagre feltenes data i SQL, <a href="@nosql-url">NoSQL</a> eller bruk ekstern lagring',
  'Better theming' =>
  'Bedre theming',
  ...
  'Bestem nøyaktig hva som vises hvor på skjermen med den nye Render API og en hel rekke nye alter hooks. Den nye RDF-modulen leverer semantisk web-markup.',
  'Accessible' =>
  'Tilgjengelig',
  ...
  'Administrasjonssidene er nå mye mer tilgjengelig. Mange forbedringer i grensesnittet gjør det enklere for deg å bygge tilgjengelige nettsteder.',
  'Images and files' =>
  'Bilder og filer',
  ...
  'Å legge bilder til innhold er nå bygget. Opprett forskjellige versjoner av miniatyrbildene, forhåndsvisning og andre bildestiler. Private og offentlige filer kan nå brukes samtidig.',
  ...
  'Et nytt automatisert test-rammeverk med over 30.000 innebygde tester gjør det mulig å gjøre <a href="@qa-url">kontinuerlige integreringstesting</a> av alle patcher til Drupal-kjerne og tredjepartsmoduler.',
  ...
  'Et nytt databaselag gir direkte støtte til SQLite, MySQL/MariaDB og PostgreSQL. Installér tredjepartsmoduler for å bruke <a href="@sqlsrv-url">MS SQL Server</a>, <a href="@oracle-url">Oracle</a>, m.m.',
  'Better distribution support' =>
  'Bedre støtte av distribusjoner',
  ...
  'Bruk installasjonsprofiler til å distribuere ditt Drupal-basert produkt. Et nytt API og eksportérbare konfigurasjoner gjør det mulig å lagre flere innstillinger i kode.',
  'Extend' =>
  'Utvid',
  ...
  'Takket være innsatsen fra fellesskapet er mer enn 800 moduler tilgjengelig eller under utvikling for Drupal 7, inkludert <a href="@views-url">Views</a>, <a href="@pathauto-url">Pathauto</a>, and <a href="@wysiwyg-url">WYSIWYG</a>, og flere kommer hver dag.',
  ...
  '<strong>Web Server</strong>: Apache (anbefales), Nginx, Lighttpd, or Microsoft IIS',
  ...
  '<strong>Minne</strong>: 32MB (Et nettsted med en rekke vanlige aktiverte moduler kan kreve 64MB minne eller mer.)',
  'More <a href="@requirements-url">requirements information</a>.' =>
  'Mer <a href="@requirements-url">info om systemkrav</a>.',
  'Attend <a href="@drupalcon-url">DrupalCon Chicago</a> to learn more about Drupal 7' =>
  'Reis til og delta på <a href="@drupalcon-url">DrupalCon Chicago</a> for å lære mer om Drupal 7',
);
