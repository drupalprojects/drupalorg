...
$strings = array(
  ...
  '我們很榮幸的為您獻上我們最好的工作成果 &ndash; Drupal 7，這個具有親和力和強大的內容管理平台，讓您能架設任何類型的網站：小至部落格或微博，大至協同合作的社群網站都可以！',
  ...
  '全新打造的管理介面能讓您能輕易找到並完成網站每日的管理工作。尤其是為網站建置與內容編輯者帶來各種友好的改進。',
  'More flexible' =>
  '更靈活彈性',
  ...
  '定義您想要的內容類型結構並增加自訂的新欄位至文章內容、使用者資訊、回應訊息中等等。更可透過 800 多個現有的 Drupal 7 模組擴展您的網站功能。',
  'More scalable' =>
  '更具擴充性',
  ...
  '藉由改進的 JavaScript 及 CSS 的最佳化、更好的快取處理機制及更多的性能改進，使得您的 Drupal 7 網站將會更快速、反應更快且可處理巨大流量。',
  'Open source' =>
  '開放源碼',
  ...
  'Come for the software, stay for the community。數以千計的精明且具高效率的人們合作來持續地改進 Drupal 核心、模組、版型及分發安裝功能。',
  'Take a tour' =>
  '看一看導覽',
  'Learn more' =>
  '學習更多',
  ...
  '更多主題在<a href="@documentation-url">線上文件</a>。',
  'Features' =>
  '功能',
  'Flexible content' =>
  '靈活的內容管理',
  ...
  '透過全新的 Render API 及底層的 Hooks ，可以完全掌控在螢幕上能看到的元素。新的 RDF 模組提供了語意網的標籤化能力。',
  'Accessible' =>
  '無障礙設計',
  ...
  '管理介面現在更易於使用了！大量前端設計的改進讓你更容易打造高可用性的網站。',
  'Images and files' =>
  '圖片與檔案',
  ...
  '現在於文章內容中加入圖片是內建功能。這項功能可以產生不同的縮圖、預覽圖或各種圖片效果樣式。改進檔案處理，私有檔案與公開檔案現在可以同時使用。',
  ...
  '全新的自動化測試架構，內建超過 30,000 個測試單元為 Drupal 核心修正檔案及社群貢獻模組進行<a href="@qa-url">持續性的整合測試</a>。',
  ...
  '透過安裝資料檔分發您自訂的 Drupal 產品。全新的 API 及匯出設定檔功能，讓您從資料庫中取得更多設定值用於程式碼中。',
  'Extend' =>
  '擴展性',
  ...
  '感謝強大的社群力量！現已有超過 800 個可使用及開發中的 Drupal 7 模組，比如：<a href="@views-url">Views</a>、<a href="@pathauto-url">Pathauto</a>及<a href="@wysiwyg-url">WYSIWYG</a>，每天有更多的模組正在加入中...',
  'See Drupal 7 in action' =>
  '看一看 Drupal 7 ',
  'Drupal 7 is already in use on hundreds of sites. Some examples include:' =>
  'Drupal 7 已經使用於數百個網站，包括：',
