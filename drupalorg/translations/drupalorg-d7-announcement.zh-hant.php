...
$strings = array(
  ...
  '我們很榮幸的為您獻上我們最好的工作成果 &ndash; Drupal 7，這個具有親和力和強大的內容管理平台，讓您能架設任何類型的網站：小至部落格或微博，大至社群及協同合作網站都可以！',
  'Get started with Drupal 7' =>
  '由此開始使用 Drupal 7',
  'Runs on Drupal 7: @site' =>
  '正在運行 Drupal 7 的網站：@site',
  'Easier to use' =>
  '更容易使用',
  ...
  '全新打造的管理介面，讓您能輕易完成網站每日的管理工作，尤其是為網站建設與內容編輯者帶來各種友好的改進。',
  'More flexible' =>
  '更靈活彈性',
  ...
  '定義您想要的內容類型結構，能增加自訂的新欄位至各種不同的文章內容、使用者資訊、回應中，等等。更可透過 800 多個現有的 Drupal 7 模組擴展您的網站功能。',
  'More scalable' =>
  '更具擴充性',
  ...
  '您的 Drupal 7 網站將會更快速。JavaScript 及 CSS 的最佳化、更好的快取處理機制及更多的性能改進，讓網站反應更快及可處理巨大流量。',
  'Open source' =>
  '自由軟體',
  ...
  '可以定義自訂欄位至不同的內容類型、使用者檔案、內容回應，分類或其他 Entities 中。儲存這些資料於 SQL、<a href="@nosql-url">NoSQL</a>，或遠端儲存裝置。',
  'Better theming' =>
  '更好的版型機制',
  ...
  '透過全新的 Render API 及底層的 Hooks ，完全掌控在螢幕上能看到的元素。新的 RDF 模組更提供了語意網站標籤解決方案。',
  'Accessible' =>
  '無障礙設計',
  ...
  '管理員界面現在更易於使用了！大量前端設計的改進令你更易打造無障礙設計網站。',
  'Images and files' =>
  '圖片與檔案',
  ...
  '內建圖片處理，可任意新增至內容中。產生不同的縮圖、預覽圖或各種圖片效果樣式。改進檔案處理，私人檔案與公開檔案現在可以同時使用。',
  ...
  '全新的自動化測試架構，內建超過 30,000 個測試單元，允許為 Drupal 核心及社群貢獻模組進行<a href="@qa-url">持續性的整合測試及修正</a>工作。',
  ...
  '新的資料庫層提供 SQLite、MySQL/MariaDB 及 PostgreSQL 支援。更可透過安裝新的模組，使用 <a href="@sqlsrv-url">MS SQL Server</a>或<a href="@oracle-url">Oracle</a>等等',
  ...
  '透過安裝資料檔分發您自訂的 Drupal 產品。全新的 API 及可匯出設定檔，讓您從程式碼中取得更多設定值。',
  'Extend' =>
  '擴展性',
  ...
  '感謝強大的社群力量！現已有超過 800 個可使用及開發中的 Drupal 7 模組，比如：<a href="@views-url">Views</a>、<a href="@pathauto-url">Pathauto</a>及<a href="@wysiwyg-url">WYSIWYG</a>，更多更多正在加入中...',
  'See Drupal 7 in action' =>
  '看一看 Drupal 7 ',
  'Drupal 7 is already in use on hundreds of sites. Some examples include:' =>
  'Drupal 7 已經使用於百多個網站，包括：',
