...
$strings = array(
  ...
  'אנו גאים להציג לכם את התוצר הטוב ביותר שלנו עד כה - דרופל 7 - מערכת ניהול התוכן הידידותית והחזקה, שמשמשת לבניית (כמעט) כל סוג אתר שהוא: מבלוגים ומיני אתרים ועד אתרי קהילות עתירות מידע ופי’צרים.',
  ...
  'ממשק ניהול מחודש מאפשר מציאה וביצוע מהיר וקל של משימות שוטפות. שיפורים רבים התווספו בייחוד עבור בוני אתרים ומנהלי תוכן.',
  'More flexible' =>
  'יותר גמישה',
  ...
  'הגדירו את מבנה התוכן שלכם, והוסיפו שדות מידע ייחודיים לתוכן, משתמשים, תגובות ועוד. הרחיבו את האתר עם מעל 800 מודולים שכבר זמינים לדרופל 7 (ועוד מאות שיתווספו בשבועות הקרובים).',
  'More scalable' =>
  'יותר scalable',
  ...
  'האתר שלכם יהיה מהיר, ויטפל בתעבורה אדירה, תודות לאופטימיזציה ל-CSS ול-JS ולמנגנוני זכרון מטמון (caching) מתקדמים.',
  'Open source' =>
  'קוד פתוח',
  ...
  'בואו בגלל התוכנה, הישארו בגלל הקהילה. אלפי אנשים, מוכשרים ויצירתיים, עובדים כל העת ביחד על מנת לשפר את דרופל, ואת רכיביה: מודולים, עיצובים והפצות.',
  'Take a tour' =>
  'צאו לסיור קצר',
  'Learn more' =>
  'לימדו עוד',
  'Get started with updated documentation for Drupal 7:' =>
  'התחילו ללמוד ולהתעדכן בעזרת המדריכים לדרופל 7:',
  '<a href="@install-url">Installing Drupal 7</a>' =>
  '<a href="@install-url">התקנת דרופל 7</a>',
  '<a href="@upgrade-url">Upgrading from version 6</a>' =>
  '<a href="@upgrade-url">שדרוג מדרופל 6</a>',
  '<a href="@api-url">API Documentation</a>' =>
  '<a href="@api-url">API Documentation</a>',
  'More topics in the <a href="@documentation-url">online documentation</a>.' =>
  'More topics in the <a href="@documentation-url">מדריכים באתר</a>.',
  'Features' =>
  'תכונות',
  'Flexible content' =>
  'תוכן גמיש',
  ...
  'הגדירו שדות ייעודיים לשימוש במספר סוגי תוכן, פרופילי משתמשים, תגובות, טקסונומיה ואחרים. המידע יכול להישמר ב-SQL, <a href="@nosql-url">NoSQL</a>, או באחסון מרוחק.',
  'Better theming' =>
  'עיצוב טוב יותר',
  ...
  'שילטו בדיוק במה מוצג ואיפה מוצג על המסך, עם ה-Render API החדש וכמה hooks חדשים ומרתקים. מודול ה-RDF החדש מספק תמיכה חיונית לווב הסמנטי.',
  'Accessible' =>
  'שימושיות',
  ...
  'מסכי הניהול הרבה יותר קלים לשימוש כעת. שיפורי תצוגה רבים עוזרים להקים אתרים נגישים יותר.',
  'Images and files' =>
  'תמונות וקבצים',
  ...
  'הוספת תמונות לתוכן היא כעת חלק בלתי נפרד מהמערכת, עם יצירת גדלים שונים לתמונות בהקשרים שונים. כעת ניתן להגן על חלק מהקבצים בסיסמא, ולאפשר צפיה בלתי מוגבלת באחרים.',
  ...
  'תשתית בדיקות אוטומטיות חדשה עם למעלה מ-30,000 טסטים, מאפשרת <a href="@qa-url">הטמעה ובדיקה מתמשכת )continuous integration testing)</a> של כל הקוד של דרופל ושל המודולים הנלווים.',
  'Improved database support' =>
  'תמיכה משופרת בבסיסי נתונים',
  ...
  'שכבת DB חדשה מספקת תמיכה מובנית ל: SQLite, MySQL/MariaDB ו-PostgreSQL. מודולים נלווים יאפשרו שימוש ב-<a href="@sqlsrv-url">MS SQL Server</a>, <a href="@oracle-url">Oracle</a>, ועוד.',
  ...
  'בנו מוצרים על גבי דרופל בעזרת שימוש בהפצות. API חדש וקונפיגורציה ברת ייצוא מאפשרים יצוא של יותר הגדרות לקוד.',
  'Extend' =>
  'הרחבות',
  ...
  'הודות למאמץ קהילתי כביר, למעלה מ-800 מודולים כבר זמינים, או נמצאים בפיתוח מתקדם לדרופל 7, כולל <a href="@views-url">Views</a>, <a href="@pathauto-url">Pathauto</a>, ו-<a href="@wysiwyg-url">WYSIWYG</a>, ועוד המתווספים כל יום.',
