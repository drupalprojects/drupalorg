...
$strings = array(
  ...
  '我们自豪的向您展示至今为止最好的作品 &ndash; Drupal 7, 这个友好而强大的内容管理平台能够搭建从博客到网络社区在内的几乎所有类型的网站。',
  ...
  '定制的字段可以用在内容类型、用户、评论、分类和其他对象上。用SQL、<a href="@nosql-url">NoSQL</a>或者远程存储来存储为这些字段存储数据。',
  'Better theming' =>
  '更棒的主题',
  ...
  '使用新的Render API和一些真正的触及根本的钩子函数来精确的控制想要展示在屏幕上的内容。新的RDF模块提供了语义化的网页标签',
  'Accessible' =>
  '可访问性',
  ...
  '管理界面更加具有可访问性。很多前端的改进让您更简单的构建高可访问性站点。',
  'Images and files' =>
  '图像和文件',
  ...
  '内容中内置里添加图片的选项。可以生成多种缩略图、预览以及其他图片样式。私有文件可以和公开文件一样进行处理。',
  ...
  '新的自动测试框架和超过30000个内置测试让我们可以不间断的测试所有的Drupal核心补丁和社区模块',
  ...
  '新的数据层为SQLite， Mysql/MariaDB和PostgreSQL提供了原生支持。启用相关模块之后可以使用<a href="@sqlsrv-url">MS SQL Server</a>, <a href="@oracle-url">Oracle</a>等其他数据库。',
  ...
  '使用安装配置文件来分发你的定制Drupal产品。新的API和导出设置可以让你在代码中捕捉更多的设置。',
  'Extend' =>
  '扩展',
  ...
  '感谢巨大的社区努力，已经有超过800个完成或者在活跃开发中的模块可以使用中Drupal 7中，包括<a href="@views-url">Views</a>、<a href="@pathauto-url">Pathauto</a>、和<a href="@wysiwyg-url">WYSIWYG</a>，而且每天都有更多的模块开始开发',
